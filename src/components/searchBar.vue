                            ...
                            <div class="input-box">
                                ...
                                <!--<transition name="fade">-->
                                    <!--<div v-if="showSearchType" class="search-type-box">-->
                                        <!--<ul>-->
                                            <!--&lt;!&ndash;<li class="item" @click="searchType = '店铺'"><i class="icon-search-type type-store"></i>店铺</li>&ndash;&gt;-->
                                            <!--<li class="item" @click="searchType = '商品'"><i class="icon-search-type type-goods"></i>商品</li>-->
                                        <!--</ul>-->
                                    <!--</div>-->
                                <!--</transition>-->
                                <input type="search" v-model="keyword" class="search-input" placeholder="搜索商品" autofocus="autofocus">
        ...
        <template v-else>
            ...
            <div class="history-search">
                <template v-if="searchHistory && searchHistory.length">
                    ...
                    <van-button size="small"  @click="handleClearHistory">清空搜索历史</van-button>
                </template>
